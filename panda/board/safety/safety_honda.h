const CanMsg HONDA_N_TX_MSGS[] = {{0xE8, 0, 5}, {0x194, 0, 4}, {0x1FA, 0, 8}, {0x30C, 0, 8}, {0x33D, 0, 5}, {0xE8, 2, 5}};
const CanMsg HONDA_N_INTERCEPTOR_TX_MSGS[] = {{0xE8, 0, 5}, {0x194, 0, 4}, {0x1FA, 0, 8}, {0x200, 0, 6}, {0x30C, 0, 8}, {0x33D, 0, 5}, {0xE8, 2, 5}};
