...
class CarInterfaceBase():
  ...
  def create_common_events(self, cs_out, extra_gears=[], gas_resume_speed=-1, pcm_enable=True):  # pylint: disable=dangerous-default-value
    ...
    if cs_out.gasPressed and False: #DISENGAGE ON GAS
    ...
    #REMOVE "FALSE and" TO DISENGAGE ON GAS
    if (False and cs_out.gasPressed and (not self.CS.out.gasPressed) and cs_out.vEgo > gas_resume_speed) or \
